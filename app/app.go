...
func NewSimApp(
	...
	app.HTLCKeeper = htlc.NewKeeper(appCodec, keys[htlc.StoreKey], app.AccountKeeper, app.BankKeeper)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		htlc.NewAppModule(app.HTLCKeeper, app.AccountKeeper, app.BankKeeper),
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		evidence.ModuleName, staking.ModuleName, ibc.ModuleName, htlc.ModuleName,
	)
